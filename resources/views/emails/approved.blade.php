...
<div style="background:#16861D;padding:50px 10px"><div class="adM">
...
<div><h1 style="color:green; font-style: italic;">APPROVED APPLICATION!!!</h1></div>
<div style="text-align:left">
 <h2>DLOS  Online Clearance System</h2>
<p>Dear Mr/Mrs <strong>{{ $rank }} {{ $first_name }} {{ $middle_name }} {{ $last_name }} {{ $qlr }} </strong></p>
<br>
@if($pdfPath)
<p>We're glad to inform you that your application has been approved.</p>
<p>See attach file</p>
@else
<p>You can now claim your certificate anytime today</p>
@endif
<!-- <p>{{ $pdfPath }}</p> -->
<br>
<p>Thank you!</p>
